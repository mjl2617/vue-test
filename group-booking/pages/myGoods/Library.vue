 ...
 -->
		...
		<el-dialog title="设置分类" :visible.sync="groupdialogVisible" width="40%" center :before-close="handleClose">
			...
			<el-row>
				<el-form style="display: flex;flex-direction: row;" ref="form" :model="form" label-width="80px">
					<el-form-item label="分类筛选">
						<el-select v-model="setForm.subCategoryId" placeholder="请选择">
...
<script>
	...
	export default {
		...
		methods: {
			...
			async typeSure() {
				let categoryName = '';
				console.log('111111',this.setForm.subCategoryId)
				...
				let {
					...
					data: {
						...
						"categoryId": this.setForm.subCategoryId,
			...
			async submit() {
				...
				// this.$router.push(`/myGoods/information?goodsId=${this.goodsId}`)
