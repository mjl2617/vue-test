<template>
	<div class="page">
		...
		<el-table :data="tableData" border style="width: 100%">
			...
			<el-table-column prop="level" label="用户星级">
			...
			<el-table-column prop="coin" label="1余额">
			</el-table-column>
			<el-table-column prop="ore" label="0.1余额">
			</el-table-column>
			<el-table-column prop="goldenOre" label="黄金矿石余额">
			</el-table-column>
			<el-table-column prop="platinumOre" label="铂金金矿石余额">
			</el-table-column>
			<el-table-column prop="address" label="参与状态">
			</el-table-column>
			...
			<el-table-column label="操作">
				<template slot-scope="scope">
					...
					<router-link :to="'/DoublingPlan/UserDetail?id='+scope.row.userId" style="color: #409EFF;text-decoration: none;font-size: 14px;">详情</router-link>
				</template>
			</el-table-column>
		</el-table>
